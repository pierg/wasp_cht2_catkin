...
if("TRUE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/davidis/catkin_ws/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/davidis/catkin_ws/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/davidis/catkin_ws/install)
...
if(NOT "/home/davidis/catkin_ws/src/apriltags/include;/usr/include/eigen3;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(apriltags_INCLUDE_DIRS "")
  set(_include_dirs "/home/davidis/catkin_ws/src/apriltags/include;/usr/include/eigen3;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/davidis/catkin_ws/src/apriltags/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
