...
if("FALSE" STREQUAL "TRUE")
  set(apriltags_SOURCE_PREFIX /home/wasp_vb/wasp_cht2_catkin/src/apriltags)
  set(apriltags_DEVEL_PREFIX /home/wasp_vb/wasp_cht2_catkin/devel)
  ...
  set(apriltags_INSTALL_PREFIX /home/wasp_vb/wasp_cht2_catkin/install)
...
if(NOT "include;/usr/include/eigen3;/usr/include/opencv;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'apriltags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wasp_vb/wasp_cht2_catkin/install/${idir}'.  Ask the maintainer 'Mitchell Wills <mwills@wpi.edu>' to fix it.")
    endif()
