...
if __name__=='__main__':
	...
	rospy.Subscriber('drone2/control_effort_slam_yaw/',Float64,ApplyControlEffort_Yaw)
	# rospy.Subscriber('control_effort_slam_x/',Float64,ApplyControlEffort_X)
	rospy.Subscriber('drone2/control_effort_slam_y/',Float64,ApplyControlEffort_Pitch)
	rospy.Subscriber('drone2/control_effort_slam_x/',Float64,ApplyControlEffort_Roll)
